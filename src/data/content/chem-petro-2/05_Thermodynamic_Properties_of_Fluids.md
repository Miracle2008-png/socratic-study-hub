...
Where:
- **$dU$**: Differential change in internal energy.
- **$dQ_{\text{rev}}$**: Differential reversible heat.
- **$dW_{\text{rev}}$**: Differential reversible work.
...
Where:
- **$dH$**: Differential change in enthalpy.
- **$dA$**: Differential change in Helmholtz energy.
- **$dG$**: Differential change in Gibbs free energy.
...
Where:
- **$\left(\frac{\partial H}{\partial T}\right)_P$**: Partial derivative of enthalpy with respect to temperature at constant pressure.
- **$\left(\frac{\partial H}{\partial P}\right)_T$**: Partial derivative of enthalpy with respect to pressure at constant temperature.
...
- **$\left(\frac{\partial V}{\partial T}\right)_P$**: Partial derivative of volume with respect to temperature at constant pressure.
...
- If the fluid is an **ideal gas**, $V = RT/P$. Therefore, $\left(\frac{\partial V}{\partial T}\right)_P = R/P$.
  ...
  Where:
  - **$dH^{\text{ig}}$**: Differential change in ideal gas enthalpy.
  - **$C_p^{\text{ig}}$**: Ideal gas constant pressure heat capacity.
