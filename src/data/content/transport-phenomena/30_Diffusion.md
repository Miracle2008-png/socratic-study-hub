...
$$ a=\exp \left({\frac {\mu -\mu _{0}}{RT}}\right) $$
...
$$ {\frac {m_{1}n_{1}m_{2}n_{2}}{P(m_{1}n_{1}+m_{2}n_{2})}}(F_{1}-F_{2}) $$
...
$$ D_{12}={\frac {3}{2n(d_{1}+d_{2})^{2}}}\left[{\frac {kT(m_{1}+m_{2})}{2\pi m_{1}m_{2}}}\right]^{1/2} $$
