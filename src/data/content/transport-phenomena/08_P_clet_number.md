...
The Péclet number is defined as
        ...
        .
    {\displaystyle \mathrm {Pe} ={\dfrac {\text{advective transport rate}}{\text{diffusive transport rate}}}.}
...
Such ratio can also be re-written in terms of times, as a ratio between the characteristic temporal intervals of the system:
        ...
        =
            ...
            advection time
        .
    {\displaystyle \mathrm {Pe} _{L}={\frac {u/L}{D/L^{2}}}={\frac {L^{2}/D}{L/u}}={\frac {\text{diffusion time}}{\text{advection time}}}.}
...
For 
        ...
        1
    {\displaystyle \mathrm {Pe_{L}} \gg 1}
