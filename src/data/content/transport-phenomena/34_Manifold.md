...
$$ T:(0,1)\rightarrow (0,1)=\chi _{\mathrm {right} }\circ \chi _{\mathrm {top} }^{-1} $$
...
$$ \textstyle \{(x_{1},x_{2},\dots ,x_{n})\mid \sum x_{i}^{2}<1\} $$
...
$$ \textstyle \{(x_{1},x_{2},\dots ,x_{n})\mid \sum x_{i}^{2}<1{\text{ and }}x_{1}\geq 0\} $$
