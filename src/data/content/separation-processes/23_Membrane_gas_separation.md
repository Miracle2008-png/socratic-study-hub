...
Then using 
    ...
    {\displaystyle n_{j}'=1-n_{i}'\quad and\quad n_{j}''=1-n_{i}''}
    ...
    {\displaystyle (1-\alpha )(n_{i}'')^{2}+(\phi +\phi (\alpha -1)n_{i}'+\alpha -1)n_{i}''-\alpha \phi n_{i}'=0}
...
## See also
Barrer – Non-SI unit of gas permeability
...
Membrane technology for nitrogen generation – Air-to-nitrogen production complexes


## References

Vieth, W.R. (1991). Diffusion in and through Polymers. Munich: Hanser Verlag. ISBN 978-3-446-15574-9.{{cite book}}:  CS1 maint: publisher location (link)