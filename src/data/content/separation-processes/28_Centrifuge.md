...
At the European Space Agency (ESA) technology center ESTEC (in Noordwijk, the Netherlands), an 8-metre (26 ft) diameter centrifuge is used to expose samples in fields of life sciences as well as physical sciences. This Large Diameter Centrifuge (LDC) began operation in 2007. Samples can be exposed to a maximum of 20 times Earth's gravity. With its four arms and six freely swinging out gondolas it is possible to expose samples with different g-levels at the same time. Gondolas can be fixed at eight different positions. Depending on their locations one could e.g. run an experiment at 5 and 10g in the same run. Each gondola can hold an experiment of a maximum 80 kilograms (180 lb). Experiments performed in this facility ranged from zebra fish, metal alloys, plasma, cells, liquids, Planaria, Drosophila or plants.
...
where
    ...
    {\displaystyle \textstyle r_{\text{mm}}}
 ...
 is the rotational radius measured in millimeters (mm), and
    ...
    {\displaystyle \textstyle N_{\text{RPM}}}
