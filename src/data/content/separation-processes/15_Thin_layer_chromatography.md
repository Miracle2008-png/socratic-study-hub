...
In normal-phase TLC, the stationary phase is polar. Silica gel is very common in normal-phase TLC. More polar compounds in a sample mixture interact more strongly with the polar stationary phase. As a result, more-polar compounds move less (resulting in smaller RF) while less-polar compounds move higher up the plate (higher RF). A more-polar mobile phase dissolves polar compounds more. As such, all compounds on the TLC plate move higher up the plate in polar solvent mixtures. "Strong" solvents move compounds higher up the plate, whereas "weak" solvents move them less.
