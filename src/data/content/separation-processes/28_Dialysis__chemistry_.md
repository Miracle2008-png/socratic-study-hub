...
For example, when dialyzing 1mL of sample against 200mL of dialysate, the concentration of unwanted dialyzable substances will be decreased 200-fold when equilibrium is attained. Following two additional buffer changes of 200mL each, the contaminant level in the sample will be reduced by a factor of 8 million (200 x 200 x 200).
...
A disadvantage is that a diffusion dialyser has a low processing capability and low processing efficiency. There are other methods such as electrodialysis and reverse osmosis that can achieve better efficiencies than diffusion dialysis.
