...
In physics, a perfect fluid or ideal fluid  is a fluid that can be completely characterized by its rest frame mass density 
...
In space-positive metric signature tensor notation, the stress–energy tensor of a perfect fluid can be written in the form $T^{\mu \nu }=\left(\rho _{m}+{\frac {p}{c^{2}}}\right)\,U^{\mu }U^{\nu }+p\,\eta ^{\mu \nu },$ where U is the 4-velocity vector field of the fluid and where $\eta _{\mu \nu }=\operatorname {diag} (-1,1,1,1)$ is the metric tensor of Minkowski spacetime.

The case where p=0 describes a dust solution. When $p=\rho _{m}c^{2}/3$ , it describes a photon gas (radiation).

In time-positive metric signature tensor notation, the stress–energy tensor of a perfect fluid can be written in the form $T^{\mu \nu }=\left(\rho _{\text{m}}+{\frac {p}{c^{2}}}\right)\,U^{\mu }U^{\nu }-p\,\eta ^{\mu \nu },$ where $U$ is the 4-velocity of the fluid and where $\eta _{\mu \nu }=\operatorname {diag} (1,-1,-1,-1)$ is the metric tensor of Minkowski spacetime.

This takes on a particularly simple form in the rest frame $\left[{\begin{matrix}\rho _{e}&0&0&0\\0&p&0&0\\0&0&p&0\\0&0&0&p\end{matrix}}\right]$ where $\rho _{\text{e}}=\rho _{\text{m}}c^{2}$ is the energy density and $p$ is the pressure of the fluid.
...
Relativistic Euler equations read $\partial _{\nu }T^{\mu \nu }=0$ in the non relativistic limit, these equations reduce to the usual Euler equations.
