...
The Laws of Thermodynamics (Spanish: Las leyes de la termodinámica) is a 2018 Spanish comedy film directed and written by Mateo Gil. The film is a romantic comedy, but is presented partially as a documentary with protagonist "physics geek" Manel attempting to explain the characters behaviour and emotion using the laws.
