...
Consider a semi-ideal heat engine, in which heat transfer takes time, according to Fourier's law of heat conduction: 
...
Consider a heat engine, with a single working fluid cycling around the engine. On one side, the working fluid has temperature 
...
, and is in direct contact with the hot heat bath. On the other side, it has temperature 
...
The heat flow into the engine is 
...
$$ k_{H} $$
 ...
 is the heat conduction coefficient. The heat flow out of the engine is 
...
, and during this time, it is in contact with the hot side only for a time 
...
$$ \eta ={\frac {\dot {W}}{{\dot {Q}}_{H}}}\leq 1-{\frac {T_{L}'}{T_{H}'}} $$
