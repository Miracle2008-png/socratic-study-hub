...
import { ECONOMICS_BRANCHES } from '../data/economicsData';
...
export const EconomicsHub: React.FC<EconomicsHubProps> = ({ onTopicSelect }) => {
  const [selectedBranch, setSelectedBranch] = useState<string | null>(null);

  if (selectedBranch) {
    const branch = ECONOMICS_BRANCHES[selectedBranch];
    return (
  ...
  return (
    <div className="engineering-hub anim-fade">
      ...
      <div className="branch-grid">
        {Object.values(ECONOMICS_BRANCHES).map((branch, index) => (
          <div 
            key={branch.id}
